...
export function createTools() {
    ...
    function createClient(baseUrl, scope) {
        const opts = {};
        if (baseUrl)
    ...
    function resolveMaildirPath(input) {
        ...
        get_message_raw: {
            ...
            handler: async (input) => {
                ...
                if (shouldCache) {
                    ...
                    const mid = msg.messageId || (msg.headers && msg.headers["message-id"]) || undefined;
            ...
            handler: async (input) => {
                ...
                if (shouldCache) {
                    ...
                    for (const m of messages) {
                        const mid = m.messageId || (m.headers && m.headers["message-id"]) || undefined;
